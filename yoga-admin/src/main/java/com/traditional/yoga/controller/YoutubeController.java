...
public class YoutubeController {
	 ...
	 private RestTemplate restTemplate;
	    ...
	    @GetMapping("/youtube-live-stream-api")
	    public Object liveStream(@RequestParam String key,@RequestParam String part,@RequestParam String q,
	            @RequestParam String channelId)throws Exception
	    {
	        ...
	        String url="https://www.googleapis.com/youtube/v3/liveBroadcasts?key={key}&part={part}&q={q}&channelId={channelId}";
	        Map<String,String>params=new HashMap<>();
	        params.put("key", key);
	        params.put("part", part);
	        params.put("q", q);
